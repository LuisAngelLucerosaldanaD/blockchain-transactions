...
type TransactionsServicesClient interface {
	...
	GetTransactionsByIDs(ctx context.Context, in *GetTransactionsByIdsRequest, opts ...grpc.CallOption) (*ResponseGetTransactionsByIds, error)
...
func (c *transactionsServicesClient) GetTransactionsByIDs(ctx context.Context, in *GetTransactionsByIdsRequest, opts ...grpc.CallOption) (*ResponseGetTransactionsByIds, error) {
	out := new(ResponseGetTransactionsByIds)
	err := c.cc.Invoke(ctx, "/transactions_proto.transactionsServices/GetTransactionsByIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionsServicesServer interface {
	...
	GetTransactionsByIDs(context.Context, *GetTransactionsByIdsRequest) (*ResponseGetTransactionsByIds, error)
...
func (UnimplementedTransactionsServicesServer) GetTransactionsByIDs(context.Context, *GetTransactionsByIdsRequest) (*ResponseGetTransactionsByIds, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionsByIDs not implemented")
}
...
func _TransactionsServices_GetTransactionsByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTransactionsByIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionsServicesServer).GetTransactionsByIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/transactions_proto.transactionsServices/GetTransactionsByIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionsServicesServer).GetTransactionsByIDs(ctx, req.(*GetTransactionsByIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionsServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTransactionsByIDs",
			Handler:    _TransactionsServices_GetTransactionsByIDs_Handler,
		},
		{
